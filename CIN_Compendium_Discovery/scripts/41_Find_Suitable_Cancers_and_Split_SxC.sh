...
#SBATCH --job-name=41_Find_Suitable_Cancers_and_Split_SxC
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "Minimum of samples: $3"
echo "Ignore splitting into BRCA subtypes: $4"
echo "SxC matrix: $5"
echo "Output directory: $6"

Rscript --vanilla ${1}/41_Find_Suitable_Cancers_and_Split_SxC.R $2 $3 $4 $5 $6
